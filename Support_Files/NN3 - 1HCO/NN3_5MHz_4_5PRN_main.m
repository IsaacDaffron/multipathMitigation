% One Hot Code output for use with a 4.5 MHz BW reference signal at an
% LTE BW of 5 MHz.
function [offset, netOut] = NN3_5MHz_4_5PRN_main(rxSig, refSig, fs, range)
    ...
    netOut = NN3_5MHz_4_5PRN_nnfunc(subs);
