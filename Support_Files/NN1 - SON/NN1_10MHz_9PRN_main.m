% The single output network for use with a 9 MHz reference signal BW at
% an LTE BW of 10 MHz.

function [offset, ccorr, t] = NN1_10MHz_9PRN_main(rxSig, refSig, fs, range)
    ...
    % Enter subsection as input to the network
    subsOff = NN1_10MHz_9PRN_nnfunc(subs);
